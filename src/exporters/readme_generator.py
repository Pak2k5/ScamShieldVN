"""README.md generator for ScamShield VN public Kaggle dataset."""
...
class ReadmeGenerator:
    """Generates README.md for the public Kaggle dataset."""

    def generate(self, output_dir: str = "./data") -> Path:
        """Generate README.md in data/public_kaggle/."""
        path = Path(output_dir) / "public_kaggle" / "README.md"
        path.parent.mkdir(parents=True, exist_ok=True)
        
        content = """# ScamShield VN – Vietnamese Online Scam & Phishing Detection Dataset
...
```"""
        ...
        logger.info("Generated README.md in public_kaggle/")
        return path
